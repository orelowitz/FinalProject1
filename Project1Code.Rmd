...
cod %>%
  ...
  ggplot(mapping = aes(x = reorder(State, -Total_Dead), y = Percent, fill = Cause))+ geom_bar(stat = "identity", position = "stack")+ theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 1))
```
